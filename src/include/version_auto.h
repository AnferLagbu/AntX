...
#define GIT_COMMIT_HASH         "3872d08879049646d5756254bf4fc44ee52f41e0"

/** @brief 短格式 Git commit hash (7字符) */
#define GIT_COMMIT_SHORT        "3872d08"
...
#define BUILD_DATE              "2026-05-10 23:26:10"
