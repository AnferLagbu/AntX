...
#define GIT_COMMIT_HASH         "76c374de13f80a741388278a928c85a5c07070db"

/** @brief 短格式 Git commit hash (7字符) */
#define GIT_COMMIT_SHORT        "76c374d"
...
#define BUILD_DATE              "2026-05-04 01:58:09"
