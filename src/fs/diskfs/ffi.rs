...
#[no_mangle]
pub extern "C" fn diskfs_read(fd: u32, buf: *mut u8, count: u32) -> i32 {
    if buf.is_null() {
        return -1;
    }
...
#[no_mangle]
pub extern "C" fn diskfs_write(fd: u32, buf: *const u8, count: u32) -> i32 {
    if buf.is_null() {
        return -1;
    }
...
#[no_mangle]
pub extern "C" fn diskfs_stat(path: *const c_char, st: *mut VfsStat, pwid: u64) -> i32 {
    if st.is_null() {
        return -1;
    }
