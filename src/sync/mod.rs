...
use core::sync::atomic::{AtomicU64, AtomicI32, AtomicU32, Ordering};

// 导入 spinlock 模块的中断控制函数
use crate::sync::spinlock::{disable_interrupts, restore_interrupts};
// 导入 IrqSaveFlags 类型
use crate::sync::types::IrqSaveFlags;
