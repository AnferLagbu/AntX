...
impl EdidDetailedTiming {
    ...
    pub fn refresh_rate(&self) -> u32 {
        ...
        let h_total = self.horizontal_resolution() as u32
            + ((self.horizontal_blanking as u32) | ((self.horizontal_blanking_high as u32 & 0x0F) << 8));
        let v_total = self.vertical_resolution() as u32
            + ((self.vertical_blanking as u32) | ((self.vertical_active_blanking_high as u32 & 0x0F) << 8));
