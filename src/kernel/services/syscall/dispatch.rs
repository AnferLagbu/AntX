...
fn dispatch_net(num: u64, args: [u64; 6]) -> Option<i64> {
    ...
    Some(match num {
        ...
        SYS_sendto => as_ret(crate::kernel::services::net::syscall::sendto_syscall(a0 as i32, a1, a2 as u32, a3 as i32, a4, a5 as u32)),
        SYS_recvfrom => as_ret(crate::kernel::services::net::syscall::recvfrom_syscall(a0 as i32, a1, a2 as u32, a3 as i32, a4, a5)),
