...
use crate::kernel::framework::proc_tcb_legacy::process::Process;
use crate::kernel::framework::proc_tcb_legacy::types::{Pid, BlockReason};
...
impl Scheduler for QueenXScheduler {
    fn enqueue(&self, pid: Pid) {
        crate::kernel::framework::proc_tcb_legacy::scheduler::SCHEDULER.add(pid);
    }

    fn enqueue_with_priority(&self, pid: Pid, level: usize) {
        crate::kernel::framework::proc_tcb_legacy::scheduler::SCHEDULER.add_with_priority(pid, level);
    }

    fn set_nice(&self, pid: Pid, nice: i8) {
        crate::kernel::framework::proc_tcb_legacy::scheduler::SCHEDULER.set_nice(pid, nice);
    }
    ...
    fn current(&self) -> Option<Pid> {
        crate::kernel::framework::proc_tcb_legacy::scheduler::SCHEDULER.current()
    }

    fn block_current(&self, reason: BlockReason) {
        crate::kernel::framework::proc_tcb_legacy::scheduler::SCHEDULER.block(reason);
    }

    fn unblock(&self, pid: Pid) {
        crate::kernel::framework::proc_tcb_legacy::scheduler::SCHEDULER.unblock(pid);
    }

    fn exit_current(&self, exit_code: u32) {
        crate::kernel::framework::proc_tcb_legacy::scheduler::SCHEDULER.exit(exit_code);
    }

    fn yield_current(&self) {
        crate::kernel::framework::proc_tcb_legacy::scheduler::SCHEDULER.yield_current();
    }

    fn set_need_reschedule(&self) {
        crate::kernel::framework::proc_tcb_legacy::scheduler::SCHEDULER.set_need_reschedule();
    }

    fn has_runnable(&self) -> bool {
        crate::kernel::framework::proc_tcb_legacy::scheduler::SCHEDULER.has_any_runnable()
    }
}
