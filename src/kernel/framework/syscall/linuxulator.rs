//! Linux ABI 兼容层 (linuxulator)
//!
//! 将 Linux 二进制的 syscall 请求翻译为 QueenX 原生调用。
//!
//! ## 架构
//!
//! ```text
...
fn translate_linux(num: u64) -> u64 {
    match num {
        ...
        56 => QX_OPEN,   // openat → QX_OPEN (libc 层处理 at 差异)
        57 => QX_CLOSE,
        62 => QX_LSEEK,
        63 => QX_READ,
        64 => QX_WRITE,
        ...
        45 => QX_TRUNCATE,
        46 => QX_FTRUNCATE,
        48 => QX_ACCESS,   // faccessat → QX_ACCESS
        49 => QX_CHDIR,
        52 => QX_FCHMOD,
        55 => QX_FCHOWN,
        61 => QX_GETDENTS, // getdents64 → QX_GETDENTS
        78 => QX_READLINK, // readlinkat → QX_READLINK
        79 => QX_STAT,     // fstatat → QX_STAT
        80 => QX_FSTAT,
        ...
        93 => QX_EXIT,
        94 => QX_EXIT_GROUP,
        95 => QX_WAIT4,    // waitid → QX_WAIT4 (语义差异由 libc 处理)
        172 => QX_GETPID,
        173 => QX_GETPPID,
        174 => QX_GETUID,
        175 => QX_GETEUID,
        ...
        // 事件轮询
        20 => QX_EPOLL_CREATE, // epoll_create1 → QX_EPOLL_CREATE
        21 => QX_EPOLL_CTL,
        22 => QX_EPOLL_WAIT,   // epoll_pwait → QX_EPOLL_WAIT

        // eventfd / signalfd / timerfd
        19 => QX_EVENTFD2,     // aarch64 只有 eventfd2
        74 => QX_SIGNALFD4,    // aarch64 只有 signalfd4
        ...
        25 => QX_FCNTL,
        32 => QX_FLOCK,
        59 => QX_PIPE2,        // aarch64 只有 pipe2

        // 文件系统操作
        34 => QX_MKDIR,        // mkdirat → QX_MKDIR
        35 => QX_UNLINK,       // unlinkat → QX_UNLINK
        36 => QX_SYMLINK,      // symlinkat → QX_SYMLINK
        37 => QX_LINK,         // linkat → QX_LINK
        38 => QX_RENAME,       // renameat → QX_RENAME
        53 => QX_FCHMODAT,     // reserved
        166 => QX_UMASK,
        ...
        102 => QX_GETITIMER,
        103 => QX_SETITIMER,
        112 => QX_CLOCK_SETTIME, // reserved
        113 => QX_CLOCK_GETTIME,
        169 => QX_GETTIMEOFDAY,

        // 其他
        17 => QX_GETCWD,
        58 => QX_PIPE,          // vhangup on aarch64, 但保留映射
        99 => QX_NICE,          // set_robust_list on aarch64, 映射待定
