...
use crate::kernel::framework::sync_tcb_legacy::rwlock::RwLock as InnerRwLock;
...
pub struct RwLockReadGuard<'a, T> {
    guard: crate::kernel::framework::sync_tcb_legacy::types::RwLockReadGuard<'a, T>,
}
...
pub struct RwLockWriteGuard<'a, T> {
    guard: crate::kernel::framework::sync_tcb_legacy::types::RwLockWriteGuard<'a, T>,
}
